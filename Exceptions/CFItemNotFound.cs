...
namespace CompoundFileStorage.Exceptions
{
    ...
    {
        internal CFItemNotFound(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }

        internal CFItemNotFound()
            : base("Entry not found")
        {
        }

        internal CFItemNotFound(string message)
            : base(message, null)
        {
        }

        internal CFItemNotFound(string message, Exception innerException)
