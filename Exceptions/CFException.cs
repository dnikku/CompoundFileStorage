...
namespace CompoundFileStorage.Exceptions
{
    ...
    {
        internal CFException()
        {
        }

        internal CFException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }

        internal CFException(string message)
            : base(message, null)
        {
        }

        internal CFException(string message, Exception innerException)
