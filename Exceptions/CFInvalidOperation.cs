...
namespace CompoundFileStorage.Exceptions
{
    ...
    public class CFInvalidOperation : CFException
    {
        ...
        internal CFInvalidOperation(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }

        internal CFInvalidOperation(string message) : base(message, null)
        {
        }

        internal CFInvalidOperation(string message, Exception innerException) : base(message, innerException)
        {
        }
    }
}